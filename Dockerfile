...
RUN DATABASE_URL="postgresql://dummy:dummy@localhost:5432/dummy" POSTGRES_USER=dummy POSTGRES_PASSWORD=dummy POSTGRES_HOST=localhost POSTGRES_PORT=5432 POSTGRES_DB=dummy npm run build
